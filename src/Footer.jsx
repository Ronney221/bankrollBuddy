...
const Footer = () => {
  return (
    <footer className="bg-neutral text-neutral-content p-2">
      <div className="flex flex-row items-center justify-between w-full">
        {/* Left Section */}
        <aside className="flex items-center space-x-2">
        <div className="flex items-center space-x-4">
          <img
            src="https://i.ibb.co/9mpW9XRV/avatar.webp" // Update with your image path
            alt="Your Name"
            className="w-12 h-12 rounded-full"
          />
          <div>
            <p className="text-sm">Developed by </p>
            <p className="font-bold">Ronney Do</p>
          </div>
        </div>
